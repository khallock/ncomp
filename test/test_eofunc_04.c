...
int main(void) {
  printf("Testing eofunc (04): ...\n");

  // Creating an empty options
  ncomp_attributes* options = ncomp_attributes_allocate(3);
  ...
  int debug = 1;
  options->attribute_array[2] = create_ncomp_single_attribute_from_scalar((char *) "debug", &debug, NCOMP_INT);
